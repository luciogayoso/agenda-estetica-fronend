...
import { GoogleOAuthProvider } from '@react-oauth/google'; // 1. Importar el proveedor
...
// 2. Obtener el Client ID de las variables de entorno de Vite
...
export default function App() {
  ...
  return (
    // 3. Envolver todo dentro de GoogleOAuthProvider
